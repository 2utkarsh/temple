    ...
    <footer class="footer">
        ...
        <!--                            <p class="footer-text">Dramatically strategize economically sound action items for e-business niches. Quickly re-engineer 24/365 potentialities before.</p>-->
        <!--                        </div>-->
        <!--                    </div>-->
        <!--                </div>-->
        <!--            </div>-->
            ...
            <div class="container">
                <div class="footer__bottom-area text-center">
                    <div class="footer__bottom-content">
                        <p class="text-white">Copyright &copy; 2024 <a href="index.php">Bhagwan Darshan</a> | Designed by <a href="https://wmtindia.in/">Web Miracle Technology</a></p>
                    </div>
                </div>
            </div>
        </div>
